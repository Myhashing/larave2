    ...
    <div class="col-sm-9">
        ...
        <div class="panel-body">
            <div class="panel-body">
                ...
                <form action="/suppliers/edit/{{$supplier->id}}" method="post" files="true" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <label for="supplier-name" class="col-sm-3 control-label"> Supplier name</label>
                        <div class="col-sm-6">
                            <input type="text" name="name" id="supplier-name" class="form-control" value="{{$supplier->name}}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="supplier-web" class="col-sm-3 control-label"> Supplier Web</label>
                        <div class="col-sm-6">
                            <input type="text" name="web" id="supplier-web" class="form-control" value="{{$supplier->web}}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="supplier-person" class="col-sm-3 control-label"> Supplier Web</label>
                        <div class="col-sm-6">
                            <input type="text" name="person" id="supplier-person" class="form-control" value="{{$supplier->person}}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="supplier-phone" class="col-sm-3 control-label"> Supplier Phone:</label>
                        <div class="col-sm-6">
                            <input type="text" name="phone" id="supplier-phone" class="form-control" value="{{$supplier->phone}}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="supplier-email" class="col-sm-3 control-label"> Supplier email:</label>
                        <div class="col-sm-6">
                            <input type="text" name="email" id="supplier-email" class="form-control" value="{{$supplier->email}}">
                        </div>
                    </div>
